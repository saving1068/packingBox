  ...
  <div class="warp" v-loading='loading'>
    ...
    <div class="table">
      <el-table :data="tableData" fit >
        ...
        <el-table-column  prop="pdCount" align='center' label="入库数量"></el-table-column>
...
<script>
import {outPdstockHistory,addPdstockHistory,stockHistoryDelete}from '@/api/pdstock'
  ...
  methods:{
    ...
    async getList(){
      try {
        ...
        let   res = await  addPdstockHistory(this.searchValue)
    ...
    async deleteFeed(item){
      try {
        ...
        let res = await  stockHistoryDelete({id:item.id})
